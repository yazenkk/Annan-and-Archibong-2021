...
merge 1:m caseidx using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/MobileCredit_attrition" //just 1 repeat in Aftrition file so do m:m
*bys caseidx: keep if _n==1  //only subjects + dropouts
...
*base 2
use "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_2/impact_covid_roundFINAL.dta", clear
keep if interviewn_result==1
bys caseidx: keep if _n==1  //only subjects + dropouts
*drop _merge
merge 1:m caseidx using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/MobileCredit_attrition" //just 1 repeat in Aftrition file so do m:m
...
*end 1
use "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_3/round3_data_21.11.dta", clear
keep if interviewn_result==1
bys caseidx: keep if _n==1  //only subjects + dropouts
merge m:m caseidx using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/MobileCredit_attrition" //just 1 repeat in Aftrition file so do m:m
*bys caseidx: keep if _n==1  //only subjects + dropouts
...
tabstat ins, stat(mean sd n) by(MobileCredit_attrition) //get means and sd
tabstat dropouts, stat(mean sd n) by(MobileCredit_attrition)
saveold "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/End1_MobileCredit_attrition", replace
...
saveold "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/End2_MobileCredit_attrition", replace



**overall rate differential?
use "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/End1_MobileCredit_attrition", clear
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/End2_MobileCredit_attrition"
...
gen end=1
gen round=3
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/End2_MobileCredit_attrition.dta"
...
merge m:m caseidx using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/_Francis_Impacts/TrtList00.dta" //bring in round 1 = base
...
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_4/round4_data_14.12.dta"
...
tab round
** add-round 3
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_3/round3_data_21.11.dta"
replace round=3 if missing(round)
tab round
** add-round 4
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_4/round4_data_19.12.dta"
replace round=4 if missing(round)
tab round
*keep if interviewn_result==1
...
tab round
** add-round 4
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_4/round4_data_13.12.dta"
replace round=4 if missing(round)
tab round
*keep if interviewn_result==1
...
**panel analysis
use "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_3/round3_data_16.11.dta", clear
gen round = 3
merge 1:1 caseidx using "MobileCredit40GHS_376list"
drop _merge
gen MobileCredit40=MobileCredit
...
append using "/Users/yazenkashlan/Dropbox (Personal)/covid19 paper/IMPACT_COVID19 DATA/DATA/Round_1/impact10.102020Final.dta"
