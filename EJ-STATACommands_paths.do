...
merge 1:m caseidx using "${data_dir}/_Francis_Impacts/MobileCredit_attrition" //just 1 repeat in Aftrition file so do m:m
*bys caseidx: keep if _n==1  //only subjects + dropouts
...
keep if interviewn_result==1
bys caseidx: keep if _n==1  //only subjects + dropouts
merge m:m caseidx using "${data_dir}/_Francis_Impacts/MobileCredit_attrition" //just 1 repeat in Aftrition file so do m:m
*bys caseidx: keep if _n==1  //only subjects + dropouts
...
tabstat ins, stat(mean sd n) by(MobileCredit_attrition) //get means and sd
tabstat dropouts, stat(mean sd n) by(MobileCredit_attrition)
saveold "${data_dir}/_Francis_Impacts/End1_MobileCredit_attrition", replace
...
saveold "${data_dir}/_Francis_Impacts/End2_MobileCredit_attrition", replace



**overall rate differential?
use "${data_dir}/_Francis_Impacts/End1_MobileCredit_attrition", clear
append using "${data_dir}/_Francis_Impacts/End2_MobileCredit_attrition"
...
tab MobileCredit_attrition
saveold "${data_dir}/_Francis_Impacts/MobileCredit_attrition", replace
...
merge m:m caseidx using "${data_dir}/_Francis_Impacts/TrtList0" //bring in round 1 = base
drop _merge 
