...
Hit Partner (1 = never to 4 = very often) & 1.134 & 0.670 & 1,103 \\ 
...
I'm depressed (1 = disagree to 5 = agree) & 1.598 & 0.942 & 1,103 \\ 
I'm relaxed (1 = disagree to 5 = agree) & 2.886 & 1.382 & 1,103 \\ 
I'm satisfied with life, all else equal (1 = disagree to 5 = agree) & 2.536 & 1.319 & 1,103 \\ 
I'm satisfied with finances, all else equal (1 = disagree to 5 = agree) & 2.074 & 1.156 & 1,103 \\ 
\hline\hline
\end{tabular}
\end{table}
