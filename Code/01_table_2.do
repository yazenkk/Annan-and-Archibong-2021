...
sum unableCall7days1 if tmt_all==0
local control_mean = string(`r(mean)', "%15.3fc")
outreg2 using "${replication_dir}/Output/Tables/table_2.tex", keep(c.tmt_all) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `control_mean') append
*dyna fig
...
local control_mean = string(`r(mean)', "%15.3fc")
outreg2 using "${replication_dir}/Output/Tables/table_2.tex", keep(c.tmt_all) addtext(District FE, No, Date FE, No, Controls, None, Mean of dep. variable, `control_mean', Lee 2009 Attrition Bounds, `lee_bounds', Imbens-Manski 2004 CS, `im_bounds', p-value: Romano-Wolf Correction, `rw_unableToCOVID1') append
...
local control_mean = string(`r(mean)', "%15.3fc")
outreg2 using "${replication_dir}/Output/Tables/table_2.tex", keep(c.tmt_all) addtext(District FE, No, Date FE, No, Controls, None, Mean of dep. variable, `control_mean', Lee 2009 Attrition Bounds, `lee_bounds', Imbens-Manski 2004 CS, `im_bounds', p-value: Romano-Wolf Correction, `rw_digitborrow1') append
...
local control_mean = string(`r(mean)', "%15.3fc")
outreg2 using "${replication_dir}/Output/Tables/table_2.tex", keep(c.tmt_all) addtext(District FE, No, Date FE, No, Controls, None, Mean of dep. variable, `control_mean', Lee 2009 Attrition Bounds, `lee_bounds', Imbens-Manski 2004 CS, `im_bounds', p-value: Romano-Wolf Correction, `rw_digitloan1') append
...
sum digitloan1 if tmt_all==0
local control_mean = string(`r(mean)', "%15.3fc")
outreg2 using "${replication_dir}/Output/Tables/table_2.tex", keep(c.tmt_all) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `control_mean') append title("Mitigation of communication constraints - unsaturated")
*dyna fig
