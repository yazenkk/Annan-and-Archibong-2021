...
foreach y in `wave2_vars' {
	...
	** constant
	loc b_`y'_0  = string(`M'[1,3], "%15.3fc")
	loc se_`y'_0 = string(`M'[2,3], "%12.3fc")
	loc p_`y'_0  = string(`M'[4,3], "%12.3fc")
...
local master_list comm wellbeing mentalh demographics morecontrols
