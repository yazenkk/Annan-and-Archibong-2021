...
outreg2 using "${replication_dir}/Output/Tables/metaEffects_consume.tex", keep(c.tmt_all) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') replace
...
pdslasso c1 tmt_all (i.districtX i.dateinterviewend female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum c1 if tmt_all==0
outreg2 using "${replication_dir}/Output/Tables/metaEffects_consume.tex", keep(c.tmt_all) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append
...
pdslasso e5 tmt_all (i.districtX i.dateinterviewend female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum e5 if tmt_all==0
outreg2 using "${replication_dir}/Output/Tables/metaEffects_consume.tex", keep(c.tmt_all) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append title(" of communication credit on consumption expenditure - unsaturated")
...
gr export "${replication_dir}/Output/Figures/meta_totExp7days.eps", replace
