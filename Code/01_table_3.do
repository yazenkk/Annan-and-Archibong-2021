...
outreg2 using "${replication_dir}/Output/Tables/table_3.tex", ///
	...
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			p-value: Romano-Wolf Correction tmt01, `rw_unableCall7days1_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_unableCall7days1_tmt02')
// sepEffects_mitigate
...
outreg2 using "${replication_dir}/Output/Tables/table_3.tex", ///
	...
	Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
	Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
	p-value: Romano-Wolf Correction tmt01, `rw_unableToCOVID1_tmt01', ///
	p-value: Romano-Wolf Correction tmt02, `rw_unableToCOVID1_tmt02')
...
outreg2 using "${replication_dir}/Output/Tables/table_3.tex", keep(tmt01 tmt02) ///
	...
	Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
	Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
	p-value: Romano-Wolf Correction tmt01, `rw_digitborrow1_tmt01', ///
	p-value: Romano-Wolf Correction tmt02, `rw_digitborrow1_tmt02')
...
outreg2 using "${replication_dir}/Output/Tables/table_3.tex", keep(tmt01 tmt02) ///
	...
	Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
	Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
	p-value: Romano-Wolf Correction tmt01, `rw_digitloan1_tmt01', ///
	p-value: Romano-Wolf Correction tmt02, `rw_digitloan1_tmt02') ///
	title("Mitigation of communication constraints - saturated")
