...
** Table A10 (metaEffects_Xpoverty)
...
outreg2 using "table_a10.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') replace
...
outreg2 using "table_a10.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append
...
** Table A11 (metaEffects_Xinformal)
...
pdslasso totExp7days1 c.tmt_all##c.informal0 (i.districtX i.dateinterviewend totExp7days female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 incomegrp0), ///
    ...
    rlasso
sum totExp7days1 if tmt_all==0
outreg2 using "table_a11.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') replace
...
pdslasso threatenPartner1 c.tmt_all##c.informal0 (i.districtX i.dateinterviewend threatenPartner female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0  incomegrp0), ///
    ...
    rlasso
sum threatenPartner1 if tmt_all==0
outreg2 using "table_a11.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append
...
pdslasso totExp7days1 c.tmt_all##c.female0 (i.districtX i.dateinterviewend totExp7days akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum totExp7days1 if tmt_all==0
outreg2 using "table_a12.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') replace
...
pdslasso threatenPartner1 c.tmt_all##c.female0 (i.districtX i.dateinterviewend threatenPartner akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum threatenPartner1 if tmt_all==0
outreg2 using "table_a12.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append
...
** Table A13 (metaEffects_Xlockeddown)
...
pdslasso totExp7days1 c.tmt_all##c.previouslock (i.districtX i.dateinterviewend totExp7days female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum totExp7days1 if tmt_all==0
outreg2 using "table_a13.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') replace
...
pdslasso threatenPartner1 c.tmt_all##c.previouslock (i.districtX i.dateinterviewend threatenPartner female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0 informal0 incomegrp0), ///
    ...
    rlasso
sum threatenPartner1 if tmt_all==0
outreg2 using "table_a13.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, Mean of dep. variable, `r(mean)') append
