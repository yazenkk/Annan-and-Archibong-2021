...
outreg2 using "table_a6.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			p-value: Romano-Wolf Correction tmt, `rw_texp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_texp1_pov_likelihood', ///
			p-value: Romano-Wolf Correction t-h, `rw_texp1_jointPov') ///
	replace
...
outreg2 using "table_a6.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_tp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_tp1_pov_likelihood', ///
			p-value: Romano-Wolf Correction t-h, `rw_tp1_jointPov') ///
	append
...
outreg2 using "table_a6.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_hp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_hp1_pov_likelihood', ///
			p-value: Romano-Wolf Correction t-h, `rw_hp1_jointPov') ///
	append
...
outreg2 using "table_a6.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_logk101_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_logk101_pov_likelihood', ///
			p-value: Romano-Wolf Correction t-h, `rw_logk101_jointPov') ///
	append
...
outreg2 using "table_a6.tex", keep(c.tmt_all c.pov_likelihood c.tmt_all#c.pov_likelihood) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_sd1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_sd1_pov_likelihood', ///
			p-value: Romano-Wolf Correction t-h, `rw_sd1_jointPov') ///
	append
...
outreg2 using "table_a7.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_texp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_texp1_informal0', ///
			p-value: Romano-Wolf Correction t-h, `rw_texp1_jointInf') ///
	replace
...
outreg2 using "table_a7.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_tp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_tp1_informal0', ///
			p-value: Romano-Wolf Correction t-h, `rw_tp1_jointInf') ///
	append
...
outreg2 using "table_a7.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_hp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_hp1_informal0', ///
			p-value: Romano-Wolf Correction t-h, `rw_hp1_jointInf') ///
	append
...
outreg2 using "table_a7.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_logk101_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_logk101_informal0', ///
			p-value: Romano-Wolf Correction t-h, `rw_logk101_jointInf') ///
	append

pdslasso sd1 c.tmt_all##c.pov_likelihood (i.districtX i.dateinterviewend severe_distress female0 akan0 married0 ageYrs0 jhs0 hhsize0 selfEmploy0  incomegrp0), ///
    partial(i.districtX) ///
    cluster(caseidx) ///
    rlasso
sum sd1 if tmt_all==0
...
outreg2 using "table_a7.tex", keep(c.tmt_all c.informal0 c.tmt_all#c.informal0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_sd1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_sd1_informal0', ///
			p-value: Romano-Wolf Correction t-h, `rw_sd1_jointInf') ///
	append
...
outreg2 using "table_a8.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_texp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_texp1_female0', ///
			p-value: Romano-Wolf Correction t-h, `rw_texp1_jointFem') ///
	replace
...
outreg2 using "table_a8.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_tp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_tp1_female0', ///
			p-value: Romano-Wolf Correction t-h, `rw_tp1_jointFem') ///
	append
...
outreg2 using "table_a8.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_hp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_hp1_female0', ///
			p-value: Romano-Wolf Correction t-h, `rw_hp1_jointFem') ///
	append
...
outreg2 using "table_a8.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_logk101_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_logk101_female0', ///
			p-value: Romano-Wolf Correction t-h, `rw_logk101_jointFem') ///
	append
...
outreg2 using "table_a8.tex", keep(c.tmt_all c.female0 c.tmt_all#c.female0) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_sd1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_sd1_female0', ///
			p-value: Romano-Wolf Correction t-h, `rw_sd1_jointFem') ///
	append
...
outreg2 using "table_a9.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_texp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_texp1_previouslock', ///
			p-value: Romano-Wolf Correction t-h, `rw_texp1_jointLoc') ///
	replace
...
outreg2 using "table_a9.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_tp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_tp1_previouslock', ///
			p-value: Romano-Wolf Correction t-h, `rw_tp1_jointLoc') ///
	append
...
outreg2 using "table_a9.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_hp1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_hp1_previouslock', ///
			p-value: Romano-Wolf Correction t-h, `rw_hp1_jointLoc') ///
	append
...
outreg2 using "table_a9.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_logk101_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_logk101_previouslock', ///
			p-value: Romano-Wolf Correction t-h, `rw_logk101_jointLoc') ///
	append
...
outreg2 using "table_a9.tex", keep(c.tmt_all c.previouslock c.tmt_all#c.previouslock) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			Mean of dep. variable, `control_mean', ///
			p-value: Romano-Wolf Correction tmt, `rw_sd1_tmt_all', ///
			p-value: Romano-Wolf Correction het, `rw_sd1_previouslock', ///
			p-value: Romano-Wolf Correction t-h, `rw_sd1_jointLoc') ///
	append
