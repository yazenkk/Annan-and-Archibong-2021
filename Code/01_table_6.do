...
outreg2 using "${replication_dir}/Output/Tables/table_6.tex", keep(tmt01 tmt02) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			Lee 2009 Attrition Bounds tmt01, `lee_bounds01', ///
			Lee 2009 Attrition Bounds tmt02, `lee_bounds02', ///
			Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
			Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
			p-value: Romano-Wolf Correction tmt01, `rw_totExp7days1_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_totExp7days1_tmt02') ///
	replace
...
outreg2 using "${replication_dir}/Output/Tables/table_6.tex", keep(tmt01 tmt02) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
			Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
			p-value: Romano-Wolf Correction tmt01, `rw_threatenPartner1_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_threatenPartner1_tmt02') ///
	append
...
outreg2 using "${replication_dir}/Output/Tables/table_6.tex", keep(tmt01 tmt02) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
			Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
			p-value: Romano-Wolf Correction tmt01, `rw_hitPartner1_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_hitPartner1_tmt02') ///
	append
...
outreg2 using "${replication_dir}/Output/Tables/table_6.tex", keep(tmt01 tmt02) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
			Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
			p-value: Romano-Wolf Correction tmt01, `rw_logk101_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_logk101_tmt02') ///
	append
...
outreg2 using "${replication_dir}/Output/Tables/table_6.tex", keep(tmt01 tmt02) ///
	addtext(District FE, Yes, Date FE, Yes, Controls, Post-Double LASSO, ///
			...
			Imbens-Manski 2004 CS tmt01, `im_bounds01', ///
			Imbens-Manski 2004 CS tmt02, `im_bounds02', ///
			p-value: Romano-Wolf Correction tmt01, `rw_severe_distress1_tmt01', ///
			p-value: Romano-Wolf Correction tmt02, `rw_severe_distress1_tmt02') ///
	append title(" of communication credit on wellbeing - saturated")
